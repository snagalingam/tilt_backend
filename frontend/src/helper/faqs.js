export const faqs = [
  ...
  },
  {
    ...
    content:
      "To qualify for financial aid, you have to be a U.S. citizen or eligible noncitizen and be enrolled in a degree or certificate program at your college or career school. That’s it! If you are an undocumented student, you might be able to apply for state financial aid.",
  },
  {
    preview: "Don't only students with good grades receive financial aid?",
    content:
      "That is a common misconception. You can receive financial aid for a variety of reasons, and good grades is only one reason. No matter what your grades are, you should always apply for financial aid.",
  },
  {
  ...
  },
  {
    ...
    content:
      "Yes, we are committed to helping students and families access financial aid free-of-charge. We only charge schools and organizations for additional services to help their students.",
  },
];
