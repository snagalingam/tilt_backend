...
const NavBar = (props) => {
  ...
  const classNavBarCollapsed = collapsed
    ...
    <nav className={navStyle(classList)}>
      <div className={containerFluid(type)}>
        ...
        <button
          ...
          data-target="#navbarGetStarted"
          aria-controls="navbarGetStarted"
          aria-expanded="false"
          aria-label="Toggle Get Started"
        >
          <a
            className="btn btn-sm btn-primary lift ml-auto"
            href="https://kellogg.qualtrics.com/jfe/form/SV_578NDO4HdsYbd4h"
            target="_blank"
