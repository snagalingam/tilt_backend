...
const Login = () => {
  ...
  const [
    loginMutation,
    { error: mutationError, data: token },
              ...
              <div className="col-10 offset-1">
                <div className="container d-flex flex-column">
                  <div className="row align-items-center justify-content-between no-gutters mt-3">
                    ...
                    <div className="col-4 text-center">
                      <p>
                        <a className="font-size-sm text-center text-muted" href="{% url 'contact' %}">
                          Contact
                        </a>
                      </p>
                    </div>
                    <div className="col-4 text-center">
                      <p className="font-size-sm text-center text-muted">
                        <a className="font-size-sm text-center text-muted" href="{% url 'privacy-policy' %}">Privacy</a>
                      </p>
                    </div>
                  </div>
                </div>
