          ...
          <div className="row align-items-center">
            ...
            >
              ...
              <h1 className="display-4 text-center text-md-left">
                Make{" "}
                <span className="text-primary">smart financial decisions</span>{" "}
              ...
              <div className="row">
                ...
                <div className="col col-md-12 ml-n5 ml-md-0">
                  ...
                  <p className="text-muted mb-6 mb-md-0">
                    Fill out a short survey where we will collect your
                    information and financial aid award letters.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-12 col-md-4">
              <div className="row">
                ...
                <div className="col col-md-12 ml-n5 ml-md-0">
                  ...
                  {/* Text */}
                  <p className="text-muted mb-6 mb-md-0">
                    We will send you report via email with a detailed breakdown
                    of each college’s financial aid offer and a comparison
                    across your options.
                  </p>
                </div>
              </div>
              ...
              <div className="row">
                ...
                <div className="col col-md-12 ml-n5 ml-md-0">
                  ...
                  <p className="text-muted mb-0">
                    As you receive more acceptances and award letters, continue
                    to send them to us, and we will continue to update your
                    report.
                  </p>
                </div>
              </div>
            ...
            <div className="col-12 col-md-6 order-md-2" data-aos="fade-left">
              ...
              <h2>
                ...
                <span className="text-success">
                  ...
                  <span
                    data-toggle="typed"
                    data-options='{"strings": ["high school seniors.", "parents.", "counselors."]}'
                  ></span>
                </span>
              </h2>
              ...
              <p className="font-size-lg text-muted mb-6">
                Using Tilt to analyze your financial aid packages means never
                being confused again about the loans, scholarships, and costs
                for each college you have been accepted into. Our reports will
                provide you true transparency into the cost of college.
              </p>
              ...
              <div className="row">
                <div className="col-12 col-lg-6">
                  ...
                  <div className="d-flex">
                    ...
                    {/* Text */}
                    <p className="text-success">Unlimited colleges</p>
                  </div>
                  ...
                  <div className="d-flex">
                    ...
                    <p className="text-success mb-lg-0">Personalized advice</p>
                  </div>
                </div>
                <div className="col-12 col-lg-6 mb-6 mb-md-0">
                  ...
                  <div className="d-flex">
                    ...
                    {/* Text */}
                    <p className="text-success">Financial aid experts</p>
                  </div>
                  ...
                  <div className="d-flex">
                    ...
                    {/* Text */}
                    <p className="text-success mb-0">Video resources</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="row justify-content-center">
                    <div className="col-12 col-xl-9">
                      ...
                      <div className="d-flex">
                        ...
                        {/* Text */}
                        <p>Breakdown for each college</p>
                      </div>
                      <div className="d-flex">
                        {/* Check */}
                        <div className="badge badge-icon badge-rounded-circle badge-success-soft mt-1 mr-4">
                        ...
                        {/* Text */}
                        <p>Comparison across colleges</p>
                      </div>
                      <div className="d-flex">
                        {/* Check */}
                        <div className="badge badge-icon badge-rounded-circle badge-success-soft mt-1 mr-4">
                        ...
                        {/* Text */}
                        <p>Access to financial aid experts</p>
                      </div>
                      <div className="d-flex">
                        {/* Check */}
                        <div className="badge badge-icon badge-rounded-circle badge-success-soft mt-1 mr-4">
            ...
            <div className="col-12 col-md-6">
              ...
              <div className="d-flex">
                ...
                <div className="ml-5">
                  ...
                  <p className="text-muted mb-6 mb-md-8">
                    Send all the award letters you have received. That can be as
                    few as 1 or more than 20.
                  </p>
                </div>
              </div>
              ...
              <div className="d-flex">
                ...
                <div className="ml-5">
                  ...
                  {/* Text */}
                  <p className="text-muted mb-6 mb-md-0">
                    Yes. We help you once you have been accepted into colleges
                    and receive your award letters.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-12 col-md-6">
              ...
              <div className="d-flex">
                ...
                <div className="ml-5">
                  ...
                  {/* Text */}
                  <p className="text-muted mb-6 mb-md-8">
                    Yes! Our product comes with a satisfaction guarantee. Submit
              ...
              <div className="d-flex">
                ...
                <div className="ml-5">
                  ...
                  {/* Text */}
                  <p className="text-muted mb-6 mb-md-0">
                    No. Keep sending your award letters when you receive them,
                    and we will update your report.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row justify-content-center">
            <div className="col-12 col-md-10 col-lg-8 text-center">
              ...
              <p className="font-size-lg text-muted mb-6 mb-md-8">
                ...
                <br />
                Tilt is faster, easier, and built by experts.
              </p>
