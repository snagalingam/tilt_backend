...
const ContactUs = () => {
  ...
  return (
    <div>
      ...
      {/* WELCOME
      ================================================== */}
      <section className="py-10 py-md-14 overlay overlay-black overlay-60 bg-cover" style= {{ backgroundImage: `url(${cover})` }}>
                ...
                <div className="row">
                  ...
                  <div className="col-12 col-md-6">
                    <div className="form-group mb-5">
                      ...
                      {/* Input */}
                      <input type="email" name="_replyto" className="form-control" id="contactEmail" placeholder="hello@domain.com" />
                ...
                <div className="row">
                  <div className="col-12">
                    <div className="form-group mb-7 mb-md-9">
                      ...
                      {/* Input */}
                      <textarea className="form-control" name="message" id="contactMessage" rows="5" placeholder="Tell us what we can help you with!"></textarea>
