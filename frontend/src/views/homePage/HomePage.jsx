      ...
      <div className="home-page-container">
        ...
        <div className="tilt-join">
          ...
          <div className="community-cards">
            <CommunityCard
              ...
              header="Sign Up"
              text="Fill out a short survey where we will collect your information and financial aid award letters."
            />
            <CommunityCard
              step="2"
              img="https://specials-images.forbesimg.com/imageserve/1157006349/960x0.jpg?fit=scale"
              header="Receive your report"
              text="We will send you report via email with a detailed breakdown of each college's financial aid offer and a comparision across your options."
            />
            <CommunityCard
              step="3"
              ...
              header="Send us more"
              text="As you receive more acceptances and award letters, continue to send them to us, and we will continue to update your report."
            />
          </div>
        </div>
        ...
        <div className="tilt-couple" style={{ marginTop: "10rem" }}>
          <div className="text">
            ...
            <p>
              ...
              being confused again about the loans, scholarships, and costs fr
              each college you have been acepted into. Our reports will provide
              you truee transparency into the cost of college.
            </p>
        ...
        <div className="tilt-couple" style={{ marginTop: "10rem" }}>
          ...
          <div className="text">
            ...
            <p>
              Using Tilt to analyze your financial aid packages means never
              beging confused again about the loans, scholarships, and costs for
              each college you have been accepted into. Our reports will provide
              you true transparency into the cost of college.
            </p>
            <div className="get-started">
