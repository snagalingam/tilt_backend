...
class Status(models.Model):
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="old_college_status_user")
    college = models.ForeignKey(
        College, on_delete=models.CASCADE, related_name="old_college_status_college")
