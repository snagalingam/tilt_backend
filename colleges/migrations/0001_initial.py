    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_photo', models.CharField(blank=True, max_length=255, null=True)),
                ('photos', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=255, null=True), default=None, null=True, size=None)),
