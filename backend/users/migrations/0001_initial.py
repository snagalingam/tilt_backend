# Generated by Django 3.0.1 on 2020-07-31 19:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'Student'), ('transfer', 'Transfer'), ('parent', 'Parent'), ('staff', 'Staff'), ('other', 'Other')], max_length=10, verbose_name='user type')),
                ('high_school_grad_year', models.CharField(max_length=4, verbose_name='high school graduation year')),
                ('income_quintile', models.CharField(blank=True, choices=[('lo', '$0 - $30,000'), ('m1', '$30,001 - $48,000'), ('m2', '$48,001 - $75,000'), ('h1', '$75,001 - $110,000'), ('h2', '$110,001+')], max_length=2, null=True, verbose_name='income quintile')),
